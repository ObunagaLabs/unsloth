...
export const ru = {
  ...
  settings: {
    ...
    debugging: {
      ...
      actions: "Все журналы",
      exportLogs: "Экспортировать все журналы (.zip)",
      exportingLogs: "Экспорт...",
      exportError: "Не удалось экспортировать журналы",
      exportPrivacyNote: "Учетные данные маскируются в экспортированных ZIP-файлах.",
      openFolder: "Открыть папку журналов",
      openingFolder: "Открытие...",
      openFolderError: "Не удалось открыть папку журналов",
