...
export const fr = {
  ...
  settings: {
    ...
    debugging: {
      ...
      exportPrivacyNote: "Les identifiants sont masqués dans les fichiers ZIP exportés.",
      openFolder: "Ouvrir le dossier des journaux",
      openingFolder: "Ouverture...",
      openFolderError: "Impossible d'ouvrir le dossier des journaux",
