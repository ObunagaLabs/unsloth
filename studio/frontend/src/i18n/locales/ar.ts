...
export const ar = {
  ...
  settings: {
    ...
    debugging: {
      ...
      pathCopy: "نسخ المسار",
      actions: "كل السجلات",
      exportLogs: "تصدير كل السجلات (.zip)",
      exportingLogs: "جارٍ التصدير...",
      exportError: "تعذر تصدير السجلات",
      exportPrivacyNote: "تُحجب بيانات الاعتماد في ملفات ZIP المصدّرة.",
      openFolder: "فتح مجلد السجلات",
      openingFolder: "جارٍ الفتح...",
      openFolderError: "تعذر فتح مجلد السجلات",
